  ...
  return (
    <div className="flex flex-col items-start justify-start w-full my-8 mx-4">
      ...
      <ul className="list-inside list-disc">
        ...
        <li className="text-base w-full text-left font-medium text-white mb-8">
          Communicating updates, offers, or other app-related information.
        </li>
      </ul>
      ...
      <p className="text-base w-full text-left font-medium text-white mb-8">
        We adopt robust security measures to protect your data from unauthorized
      ...
      <p className="text-base w-full text-left font-medium text-white mb-8">
        We will retain your information only for as long as necessary for the
      ...
      <p className="text-base w-full text-left font-medium text-white mb-8">
        ...
        encourage users to check this page for any changes.
      </p>
      ...
      <p className="text-base w-full text-left font-medium text-white mb-8">
        You have the right to access, edit, or delete your personal data at any
        time. You can do this by contacting us.
      </p>

      <p className="text-lg w-full text-left font-bold text-white">
        11. Contact Us
      </p>
      <p className="text-base w-full text-left font-medium text-white">
